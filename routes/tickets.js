...
export default function (io) {
    ...
    socket.on('sendTicketMessage', async ({ ticketId, sender, content }) => {
        try {
            ...
            // Broadcast the message to everyone in this ticket room
            io.to(`ticket_${ticketId}`).emit('newTicketMessage', {
                ticketId,
                sender,
                content,
                timestamp: new Date(),
